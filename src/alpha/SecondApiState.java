 ...
 */
public class SecondApiState implements AbsApiState {
    ...
    public SecondApiState(boolean isTest) {
    ...
    public synchronized AbsMTProtoState getMtProtoState(final int dcId) {
        return new AbsMTProtoState() {
            ...
            public byte[] getAuthKey() {
                return SecondApiState.this.getAuthKey(dcId);
            }

            @Override
            public ConnectionInfo[] getAvailableConnections() {
                return SecondApiState.this.getAvailableConnections(dcId);
            }
